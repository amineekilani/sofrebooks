                        ...
                        {user && (
                            <>
                                <div className="space-y-2">
                                    <Link to="/mybooks" className="block text-orange-600 hover:text-orange-500">My Livres</Link>
                                    <Link to="/myrequests" className="block text-orange-600 hover:text-orange-500">My Demandes</Link>
                                </div>
                            </>
                        )}
                    </div>
